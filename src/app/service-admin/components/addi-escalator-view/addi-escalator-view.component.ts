...
@Component({
  selector: 'app-addi-escalator-view',
  templateUrl: './addi-escalator-view.component.html',
  styleUrls: ['./addi-escalator-view.component.css']
})
export class AddiEscalatorViewComponent implements OnInit {
  ...
  constructor(private router: Router, private toastr: ToastrManager, private _api: ApiService, @Inject(SESSION_STORAGE) private storage: StorageService,private route: ActivatedRoute) { }
    ...
    //this
    this._api.get_additional_for_escalator_view(datas).subscribe((response: any) => {
