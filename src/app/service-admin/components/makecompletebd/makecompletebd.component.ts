...
@Component({
  selector: 'app-makecompletebd',
  templateUrl: './makecompletebd.component.html',
  styleUrls: ['./makecompletebd.component.css']
})
export class MakecompletebdComponent implements OnInit {
  final_data = [];
  search:any;
  searchQR : any;
  S_Date:any;
...
JOB_END_TIME : ""+new Date(),
  ...
  submit(){
    ...
    this._api.breakdown_date_wise_filter(data).subscribe((data:any)=>{
     this.rows=data['Data'];
