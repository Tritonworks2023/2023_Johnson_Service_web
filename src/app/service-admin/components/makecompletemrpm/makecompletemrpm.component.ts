...
@Component({
  selector: 'app-makecompletemrpm',
  templateUrl: './makecompletemrpm.component.html',
  styleUrls: ['./makecompletemrpm.component.css']
})
export class MakecompletemrpmComponent implements OnInit {
...
JOB_END_TIME : ""+new Date(),
   ...
   this._api.mr_preventive_mark_complete(a).subscribe((data:any)=>{
  ...
  submit(){
    ...
    this._api.mr_preventive_date_wise_filter(data).subscribe((data:any)=>{
     this.rows=data['Data'];
