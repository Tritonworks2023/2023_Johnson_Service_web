...
@Component({
  selector: 'app-serviceagentdeactive',
  templateUrl: './serviceagentdeactive.component.html',
  styleUrls: ['./serviceagentdeactive.component.css']
})
export class ServiceagentdeactiveComponent implements OnInit {
  final_data = [];
  value:any;
  S_Date:any;
  E_Date:any;
  ...
  ngOnInit(): void {
    ...
    this._api.deactive_service_employee_list().subscribe((data:any)=>{
      this.rows=data['Data']
